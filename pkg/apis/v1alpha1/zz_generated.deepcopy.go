...
func (in *ECSNodeClassSpec) DeepCopyInto(out *ECSNodeClassSpec) {
	*out = *in
	...
	if in.HMISelectorTerms != nil {
		in, out := &in.HMISelectorTerms, &out.HMISelectorTerms
		*out = make([]HMISelectorTerm, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HMISelectorTerm) DeepCopyInto(out *HMISelectorTerm) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HMISelectorTerm.
func (in *HMISelectorTerm) DeepCopy() *HMISelectorTerm {
	if in == nil {
		return nil
	}
	out := new(HMISelectorTerm)
	in.DeepCopyInto(out)
	return out
}
